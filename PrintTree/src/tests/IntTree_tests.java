...
class IntTree_tests {
    ...
    void test_toPreOrderString() {
        ...
        Assert.assertEquals("tree is empty", tree.toPreOrderString());
        tree = new IntTree("2");
        Assert.assertEquals("[2]()()", tree.toPreOrderString());
        tree = new IntTree("2 1 3");
        Assert.assertEquals("[2]([1]()())([3]()())", tree.toPreOrderString());
        tree = new IntTree("7 5 9 4 12 6 10");
    ...
    void test_toInOrderString() {
        IntTree tree = new IntTree("");
        Assert.assertEquals("tree is empty", tree.toInOrderString());
        tree = new IntTree("2");
    ...
    void test_toPostOrderString() {
        IntTree tree = new IntTree("");
        Assert.assertEquals("tree is empty", tree.toPostOrderString());
        tree = new IntTree("2");
